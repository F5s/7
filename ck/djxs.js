...
https://dj.palmestore.com/zytc/public/index.php?
https://dj.palmestore.com/zyuc/api/user/my/tab?
...
if ($request.url.indexOf(path4) != -1){
	...
	obj.body.cardInfo.desc = "2121-01-06 到期",
	obj.body.vipInfo.vipType = 2,
	obj.body.vipInfo.vipExpire = 4811209694000
}else {
	obj.body.userInfo.vipInfo.vipType = 2,
